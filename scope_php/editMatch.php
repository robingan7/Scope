...
if(isset($_POST) && !empty($_POST)) {
    ...
    if(mysqli_num_rows($result2)!=0){
        $sql3="UPDATE `manager_info` SET `matchform`='$result_pit' WHERE teamnumber='$teamnumber' AND name='$name';";
        $updatemanager=mysqli_query($conn,$sql3);
        $sql4="UPDATE `scout_info` SET `matchform`='$result_pit' WHERE teamnumber='$teamnumber';";
